...
import IconPartlyCloudRain from "@/assets/icons/partly-cloudy-day-rain.svg";
...
<template>
  <div class="icon">
    ...
    <IconPartlyCloud
      v-else-if="prec === 0 && max > 15 && max <= 21 && min >= 5"
    ...
    <IconNotAvailable v-else alt="Sin datos claros" />
  </div>
</template>
